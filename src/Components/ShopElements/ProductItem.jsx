            ...
            <div className="product_thumb">
                <div className="product_imagebox">
                    ...
                    <div className="cart_button">
                        <a href="/project" className="button effect_1">
                            Add to Cart
                        </a>
                    </div>
                </div>
                <div className="product_item_inner">
                    <div className="label_text">
                        <h4 className="product_item_name"><a href="/project">{name}</a> <span className="product_item_price"><del className={oldClass}>{oldPrice}</del> {price}</span></h4>
                        <div className="product_category"><a href="/project">{category}</a></div>
                    </div>
                </div>
            </div>
        </div>
